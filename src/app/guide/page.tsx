      ...
      <div className="mt-6 flex flex-col gap-6">
        <Section id="login" title="1. 최초 로그인 및 비밀번호 변경">
          ...
          <div className="flex flex-col gap-2">
            ...
            <Step n={3}>
              ...
              입력하고 저장합니다. 로그인 이메일도 이 화면에서 변경할 수
              있습니다.
            </Step>
            <Step n={4}>
              이메일을 변경한 경우 다음 로그인부터는 새 이메일을 사용해야
              합니다.
            </Step>
          </div>
          <Note>
        ...
        <Section id="workflow" title="2. Work Order 흐름 체계">
          ...
          <div className="flex flex-col gap-2">
            ...
            <Step n={3}>
              ...
              업데이트하고, 진행 경과(텍스트/스크린샷/참고 파일 경로)를 남깁니다.
            </Step>
            <Step n={4}>
        ...
        <Section id="usage" title="3. 화면별 이용 방법">
          ...
          <p>
            ...
            참고사항을 수정하고, 진행 경과를 기록합니다. 하위 업무가 있는
            업무는 진행률을 직접 입력할 수 없고 하위 업무 평균으로 자동
            계산됩니다. 개인에게 할당된 업무는 &quot;담당자 변경(이관)&quot;
            으로 내 권한 범위 안의 다른 사람에게 넘길 수 있습니다.
          </p>
          <p>
            <strong>진행 경과 기록</strong> — 상세 화면 하단에서 텍스트로 경과를
            남기고, 스크린샷은 입력창에 <strong>Ctrl+V로 붙여넣기</strong>하거나
